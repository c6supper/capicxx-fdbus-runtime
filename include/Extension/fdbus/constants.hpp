...
#ifndef FDBUS_CONSTANTS_HPP
#define FDBUS_CONSTANTS_HPP

#include <string>

#include <Extension/fdbus/primitive_types.hpp>
#include <Extension/fdbus/enumeration_types.hpp>
